...
public class tampil_semua_burung extends AppCompatActivity implements ListView.OnItemClickListener{
    private ListView listView;
    private String JSON_STRING;

    @Override protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tampil_semua_burung);
    ...
    private void showMhs(){
        ...
        ListAdapter adapter = new SimpleAdapter(
                tampil_semua_burung.this, list, R.layout.list_item,
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(tampil_semua_burung.this,"Mengambil Data","Mohon Tunggu...",false,false);
            }
            @Override
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Intent intent = new Intent(this, edit_data_burung.class);
